        ...
        <div>
            <div className=' rounded-xl shadow p-5'>
                ...
                <div className='grid grid-cols-3 gap-3'>
                    <button onClick={() => handleCheck("Call")} className=' electric-glow rounded-xl py-4 flex flex-col items-center gap-1 cursor-pointer hover:bg-gray-600'>
                        <span className='text-xl'><MdAddCall /></span>
                        <span className='text-sm'>Call</span>
                    </button>
                    <button onClick={() => handleCheck("Text")} className='electric-glow rounded-xl py-4 flex flex-col items-center gap-1 cursor-pointer hover:bg-gray-600'>
                        <span className='text-xl'><IoMdText /></span>
                        <span className='text-sm'>Text</span>
                    </button>
                    <button onClick={() => handleCheck("Video")} className='electric-glow cursor-pointer rounded-xl py-4 flex flex-col items-center gap-1 hover:bg-gray-600'>
